...
class AdvApp2Var_ApproxAFunc2Var {
	...
	:param Dimension:
	:type Dimension: int
	:rtype: opencascade::handle<TColStd_HArray1OfReal>") UFrontError;
	...
	:param Dimension:
	:type Dimension: int
	:rtype: opencascade::handle<TColStd_HArray1OfReal>") VFrontError;
...
class AdvApp2Var_Context {
	public:
		...
		%feature("autodoc", ":rtype: None") AdvApp2Var_Context;
		 AdvApp2Var_Context ();
	...
	:rtype: None") AdvApp2Var_Context;
		...
		%feature("autodoc", ":rtype: opencascade::handle<TColStd_HArray1OfReal>") VJacMax;
		opencascade::handle<TColStd_HArray1OfReal> VJacMax ();

		/****************** VLimit ******************/
		%feature("compactdefaultargs") VLimit;
		%feature("autodoc", ":rtype: int") VLimit;
		Standard_Integer VLimit ();

		/****************** VOrder ******************/
		%feature("compactdefaultargs") VOrder;
		%feature("autodoc", ":rtype: int") VOrder;
		Standard_Integer VOrder ();

		/****************** VRoots ******************/
		%feature("compactdefaultargs") VRoots;
		%feature("autodoc", ":rtype: opencascade::handle<TColStd_HArray1OfReal>") VRoots;
...
class AdvApp2Var_Criterion {
	...
	:rtype: bool") IsSatisfied;
		...
		%feature("autodoc", ":rtype: float") MaxValue;
		Standard_Real MaxValue ();

		/****************** Repartition ******************/
		%feature("compactdefaultargs") Repartition;
		%feature("autodoc", ":rtype: AdvApp2Var_CriterionRepartition") Repartition;
		AdvApp2Var_CriterionRepartition Repartition ();

		/****************** Type ******************/
		%feature("compactdefaultargs") Type;
		%feature("autodoc", ":rtype: AdvApp2Var_CriterionType") Type;
...
class AdvApp2Var_Framework {
	public:
		...
		%feature("autodoc", ":rtype: None") AdvApp2Var_Framework;
		 AdvApp2Var_Framework ();
	...
	:type IndexNode: int
	:rtype: AdvApp2Var_Node") ChangeNode;
	...
	:param IndexStrip:
	:type IndexStrip: int
	:rtype: opencascade::handle<TColStd_HArray1OfReal>") UEquation;
	...
	:param IndexStrip:
	:type IndexStrip: int
	:rtype: opencascade::handle<TColStd_HArray1OfReal>") VEquation;
...
class AdvApp2Var_Network {
	...
	:type Index: int
	:rtype: AdvApp2Var_Patch") ChangePatch;
...
class AdvApp2Var_Node {
	...
	:rtype: None") AdvApp2Var_Node;
		...
		%feature("autodoc", ":rtype: gp_XY") Coord;
		gp_XY Coord ();
...
class AdvApp2Var_Patch {
	...
	:rtype: None") AdvApp2Var_Patch;
		...
		%feature("autodoc", ":rtype: opencascade::handle<TColStd_HArray1OfReal>") AverageErrors;
	...
	:rtype: opencascade::handle<TColStd_HArray1OfReal>") Coefficients;
		...
		%feature("autodoc", ":rtype: float") CritValue;
		Standard_Real CritValue ();

		/****************** CutSense ******************/
		%feature("compactdefaultargs") CutSense;
		%feature("autodoc", ":rtype: int") CutSense;
	...
	:rtype: None") Discretise;
		...
		%feature("autodoc", ":rtype: bool") IsApproximated;
		Standard_Boolean IsApproximated ();

		/****************** IsDiscretised ******************/
		%feature("compactdefaultargs") IsDiscretised;
		%feature("autodoc", ":rtype: bool") IsDiscretised;
		Standard_Boolean IsDiscretised ();

		/****************** IsoErrors ******************/
		%feature("compactdefaultargs") IsoErrors;
		%feature("autodoc", ":rtype: opencascade::handle<TColStd_HArray2OfReal>") IsoErrors;
	...
	:rtype: opencascade::handle<TColgp_HArray2OfPnt>") Poles;
		...
		%feature("autodoc", ":rtype: None") ResetApprox;
		void ResetApprox ();
	...
	:rtype: None") SetCritValue;
		...
		%feature("autodoc", ":rtype: float") V0;
		Standard_Real V0 ();
...
class AdvApp2Var_SysBase {
	public:
		...
		%feature("autodoc", ":rtype: None") AdvApp2Var_SysBase;
		 AdvApp2Var_SysBase ();

		/****************** do__fio ******************/
		%feature("compactdefaultargs") do__fio;
		%feature("autodoc", ":rtype: int") do__fio;
		static int do__fio ();

		/****************** do__lio ******************/
		%feature("compactdefaultargs") do__lio;
		%feature("autodoc", ":rtype: int") do__lio;
		static int do__lio ();
	...
	:rtype: int") maermsg_;
		...
		%feature("autodoc", ":rtype: int") mainial_;
		int mainial_ ();
	...
	:rtype: void") miraz_;
		...
		%feature("autodoc", ":rtype: integer") mnfndeb_;
